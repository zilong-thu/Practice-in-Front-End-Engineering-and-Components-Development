...
如果你没有 Mac，那么推荐安装任何一款你喜欢的 Linux 操作系统。Ubuntu<sup>[2]</sup> 有着友好的界面，通常是入门者的选择；而 CentOS<sup>[3]</sup> 由于在服务器端的应用更为广泛，也是非常适合开发者安装的系统；一些更为资深的开发者会选择 Arch Linux<sup>[4]</sup>，读者也可以有余力的时候挑战一下。
